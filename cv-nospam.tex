...
\newboolean{isfreelance}
\setboolean{isfreelance}{@ISFREELANCE@}
...
\header
  ...
  {\color{headerbluefont} \emph{\ifthenelse{\boolean{isfreelance}}{{\bfseries \langFreelance} - }{}\FPround\myage{\myage}{0}\myage+ \langHeaderExperience}}
